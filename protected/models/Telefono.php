...
class Telefono extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('telefono, idusuario, idtipo_telefono', 'required'),
			array('telefono, idusuario, idtipo_telefono', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('telefono, idusuario, idtipo_telefono', 'safe', 'on'=>'search'),
		);
	}
